...
#create the Orders class which takes id, product, quantity, address, amount etc
...
class Orders(db.Model):
    ...
    @staticmethod
    #assign values with each variable for prodcut, id etc
    ...
    #create update function that updates the user information
