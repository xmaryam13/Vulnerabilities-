...
#the respective modules are imported 

cli = FlaskGroup(create_app=create_app)

#created a variable that stores the data of all the users such as their:
# name, email, password and their contact number.
user_json = [
	{
		"name": "John Doe",
...
#created a variable that stores the product information such as the:
#product name, image, rating, marked price and the price that it is being sold at
