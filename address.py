...
class Address(db.Model):
    ...
    @staticmethod
    #create the funtion that assigns the variables to the id, addresses etc.
    ...
    #this funtion updates the users information when they change anyone of their details
